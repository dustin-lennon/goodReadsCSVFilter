...
describe('ActiveSeriesService', () => {
    const mockGetCurrentlyReadingBooks = GoodreadsCSVService.getCurrentlyReadingBooks as jest.MockedFunction<typeof GoodreadsCSVService.getCurrentlyReadingBooks>;
    const mockGetReadingNextBooks = GoodreadsCSVService.getReadingNextBooks as jest.MockedFunction<typeof GoodreadsCSVService.getReadingNextBooks>;
    const mockGetReadBooks = GoodreadsCSVService.getReadBooks as jest.MockedFunction<typeof GoodreadsCSVService.getReadBooks>;
